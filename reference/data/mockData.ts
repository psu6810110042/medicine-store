// Mock Data for MEDS E-Commerce Platform
...
export interface Order {
  ...
  status:
  | "pending"
  | "prescription_request" // Added for pharmacist to fill
  | "verified"
  | "preparing"
  | "shipped"
  | "delivered"
  ...
  userNotes?: string; // Notes from the user (e.g., symptoms)
}
...
export const mockUsers: User[] = [
  {
    ...
    healthData: {
      ...
      currentMedications: ["เมทฟอร์มิน", "แอมโลดิพีน"],
    },
  },
  {
    id: "user-002",
    email: "pharmacist@meds.com",
    phone: "0823456789",
    name: "ภก.สมหญิง เภสัชกร",
    role: "pharmacist",
  },
  {
    id: "user-003",
...
export const mockOrders: Order[] = [
  ...
  },
  {
    ...
    verifiedBy: "user-002",
    verifiedAt: "2024-02-01T10:00:00",
  },
  {
    id: "ORD-2024-004",
    userId: "user-001",
    ...
    verifiedBy: "user-002",
    verifiedAt: "2024-02-05T17:30:00",
  },
  {
    id: "ORD-2024-005",
    userId: "user-001",
    ...
    verifiedBy: "user-002",
    verifiedAt: "2024-02-08T12:00:00",
    pharmacistNotes: "สินค้าพร้อมจัดส่ง กรุณาทานหลังอาหาร",
  },
];
