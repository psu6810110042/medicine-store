...
export default function ImageUpload({ folder = 'products' }: { folder?: string }) {
    ...
    return (
        <div className="p-6 bg-card rounded-xl border border-border shadow-sm max-w-md w-full mx-auto mt-8">
            <h3 className="text-lg font-semibold mb-4 text-foreground">Test Image Upload</h3>
