  ...
  return (
    <div className="min-h-screen bg-background p-8">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        {/* Slip Verification Quick Access */}
        <Link href="/admin/orders">
          <div className="mb-6 flex items-center gap-5 rounded-2xl border-2 border-indigo-100 bg-indigo-50 p-5 hover:border-indigo-300 hover:bg-indigo-100 transition-colors cursor-pointer">
            <div className="p-3 bg-indigo-600 rounded-xl shrink-0">
              <CreditCard className="h-6 w-6 text-white" />
            </div>
            <div className="flex-1">
              <p className="font-bold text-indigo-900">ตรวจสอบสลิปโอนเงิน</p>
              <p className="text-sm text-indigo-600 mt-0.5">ดูรายการชำระเงินที่รอยืนยัน และอนุมัติหรือปฏิเสธสลิป</p>
            </div>
